...
private function wwpdf_download( $file_path, $product_id, $order_key, $email ) {
  ...
  $file_extension = strtolower( substr( strrchr( $file_path, "." ), 1 ) );    
    ...
    // wwpdf_overlay_bold
    // wwpdf_overlay_color
    // wwpdf_overlay_rotate
    // wwpdf_overlay_finetune_X
    // wwpdf_overlay_finetune_Y
    // wwpdf_footer_input
    // wwpdf_footer_size
    // wwpdf_footer_color
    // wwpdf_footer_finetune_Y
    //
    // IDEAS FROM WP PDF STAMPER:

    // use UTF-8 font (for accented characters)
    //
    ///////////////////////////////////
...
//      require_once( 'class_wwpdf_watermark.php' );
      ...
      $wwpdf_footer_find = array( '/\[FIRSTNAME\]/','/\[LASTNAME\]/','/\[EMAIL\]/' );
      $wwpdf_footer_replace = array( $first_name, $last_name, $email );

      $wwpdf_footer_input = preg_replace( $wwpdf_footer_find, $wwpdf_footer_replace, $wwpdf_footer_input );
